...
export default class CategoryList extends React.Component {
    ...
    renderItems(category) {
        return category.map((item) => {
            return (
                <TouchableWithoutFeedback onPress={() => this.props.navigation.navigate('productList')}>
