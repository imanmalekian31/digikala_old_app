...
class CompleteList extends React.Component {
    ...
    renderFormatApp() {
        ...
        return this.props.digitalTools[key].map((item, index) => {
            return (
                <TouchableOpacity style={{width: '50%'}} key={index} activeOpacity={.9}
    ...
    renderFormatList() {
        ...
        return this.props.digitalTools[key].map((item, index) => {
            return (
                <TouchableOpacity key={index} activeOpacity={.9}
                                  onPress={() => this.props.navigation.navigate('productDetails', {
                                      product: item,
                                  })}>
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <TouchableOpacity onPress={() => {
                            ...
                            icon === 1 ? this.setState({case: 2}) : this.setState({case: 1});
                        }}>
                            {this.state.case === 1 ?
                    ...
                    <View style={{
                        ...
                        <View style={{justifyContent: 'center', alignItems: 'center', marginLeft: 3}}>
                            ...
                            <Text style={{fontFamily: 'IRANSansMobile', fontSize: 8, color: 'gray'}}>پرفروش ترین</Text>
                        </View>
                    </View>
                    <View style={{
                        flex: 6, height: '100%',
                        ...
                        <View style={{justifyContent: 'center', alignItems: 'center', marginLeft: 3}}>
                            ...
                            <Text style={{fontFamily: 'IRANSansMobile', fontSize: 8, color: 'gray'}}>رنگُ،نوع،قیمت‌و...</Text>
                        </View>
                    </View>
                </View>
                <ScrollView>
                    <View style={{flexDirection: 'row', width: '100%', flexWrap: 'wrap', marginBottom: 60}}>
                        {this.state.case === 1 ? this.renderFormatApp() : this.renderFormatList()}
                    </View>
                </ScrollView>
            </View>
        );
...
export default connect(mapStateToProps, null)(CompleteList);
