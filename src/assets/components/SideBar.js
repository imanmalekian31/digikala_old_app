    ...
    return (
      <SafeAreaView
        ...
        <View style={style.header}>
          ...
          <TouchableWithoutFeedback
            ...
            <View style={style.headerName}>
              <Text style={{fontFamily: 'IRANSansMobile', color: '#fff'}}>
                ایمان ملکیان
              </Text>
            </View>
          </TouchableWithoutFeedback>
        ...
        <ScrollView>
          ...
          <SideBarItem
            name={'پیشنهاد ویژه دیجی کالا'}
            nav={'more'}
            type="پیشنهاد ویژه دیجی کالا"
            page="0"
            icon={'star'}
          />
          <SideBarItem
